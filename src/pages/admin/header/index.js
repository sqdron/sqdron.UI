...
class Header extends React.Component {
  componentDidMount() {
    var Main = function () {
      var $html = $('html'), $win = $(window), MEDIAQUERY = {};
      ...
      var sidebarHandler = function () {
        var eventObject = isTouch() ? 'click' : 'mouseenter', ul = "", menuTitle, _this,  $winOffsetTop = 0, $winScrollTop = 0, $appWidth, space = 0;
        ...
        $('#sidebar').on(eventObject, 'a', function (e) {
        ...
        $('.app-aside').on('mouseleave', function (e) {
        ...
        $(document).on("mousedown touchstart", function (e) {
          if ($('#sidebar').has(e.target).length === 0 && !$('#sidebar').is(e.target) && !$('.sidebar-mobile-toggler').is(e.target) && ($('#app').hasClass('app-slide-off') || $('#app').hasClass('app-offsidebar-open'))) {
            resetSidebar();
          }
        });
      ...
      var searchHandler = function () {
        ...
        var searchForm = $('#sidebar').children('form');
        var formWrap = $('#sidebar').parent();
    ...
    return (
      <header className="navbar navbar-default navbar-static-top">
        <div className="navbar-header">
          <button href="#"
                  className="sidebar-mobile-toggler pull-left btn no-radius hidden-md hidden-lg btn btn-navbar sidebar-toggle"
          ...
          <a className="navbar-brand navbar-brand-collapsed" href="index.html"> <img
            src={require('../../../assets/images/logo-collapsed.png')} alt=""/> </a>
        </div>
        <div className="navbar-collapse collapse">
          <ul className="nav navbar-left hidden-sm hidden-xs">
            <li className="sidebar-toggler-wrapper">
              <div>
                <button href="javascript:void(0)" className="btn sidebar-toggler visible-md visible-lg">
                  <i className="fa fa-bars"></i>
                </button>
              </div>
            </li>
